...
return new class extends Migration
{
    ...
    public function up(): void
    {
        foreach ($this->columns as $column) {
            Schema::table('row_items', function (Blueprint $table) use ($column) {
        ...
        DB::table('row_items')->orderBy('id')->get()->each(function ($row) {
            DB::table('row_items')->where('id', $row->id)->update([
